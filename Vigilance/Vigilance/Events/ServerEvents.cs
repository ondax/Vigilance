...
namespace Vigilance.Events
{
	...
	public class CheaterReportEvent : Event
	{
		...
		public override void ExecuteHandler(Handler handler)
		{
			...
			Data.Sitrep.Post(Data.Sitrep.Translation.Report(this), API.Enums.PostType.Report);
		}
	}
	...
	public class RACommandEvent : Event
	{
		...
		public override void ExecuteHandler(Handler handler)
		{
			if (Command != "REQUEST_DATA PLAYER_LIST SILENT")
				FileLog.RemoteAdminLog(Command, Admin);
			((RACommandEventHandler)handler).OnCommand(this);
			Data.Sitrep.Post(Data.Sitrep.Translation.Command(this), API.Enums.PostType.RemoteAdmin);
		}
	}
