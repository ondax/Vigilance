...
namespace Vigilance.API
{
    ...
    public class Class
    {
        ...
        public void Replace()
        {
            ...
            newRoles.Add(_role);
            CharacterClassManager._staticClasses = newRoles.ToArray();
            foreach (ReferenceHub hub in ReferenceHub.GetAllHubs().Values)
            {
                hub.characterClassManager.Classes = newRoles.ToArray();
            }
            ReferenceHub.LocalHub.characterClassManager.Classes = newRoles.ToArray();
            ReferenceHub.HostHub.characterClassManager.Classes = newRoles.ToArray();
        }
